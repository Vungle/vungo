...
func TestVersionValidateErrors(t *testing.T) {
	...
	version3 := vastelement.Version3
	version4 := vastelement.Version("4.1")
	...
	vasttest.VerifyVastElementErrorAsExpected(t, version4, version4.Validate(vastelement.Version3), nil)
}
