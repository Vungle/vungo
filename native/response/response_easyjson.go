...
func easyjson6ff3ac1dDecodeGithubComVungleVungoNativeResponse(in *jlexer.Lexer, out *Response) {
...
func easyjson6ff3ac1dEncodeGithubComVungleVungoNativeResponse(out *jwriter.Writer, in Response) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ver != "" {
...
func (v Response) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6ff3ac1dEncodeGithubComVungleVungoNativeResponse(&w, v)
...
func (v *Response) UnmarshalJSON(data []byte) error {
	...
	easyjson6ff3ac1dDecodeGithubComVungleVungoNativeResponse(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Response) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6ff3ac1dDecodeGithubComVungleVungoNativeResponse(l, v)
}
