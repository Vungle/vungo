...
func easyjson16eb09bcDecodeGithubComVungleVungoNativeResponse(in *jlexer.Lexer, out *Link) {
...
func easyjson16eb09bcEncodeGithubComVungleVungoNativeResponse(out *jwriter.Writer, in Link) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Link) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson16eb09bcEncodeGithubComVungleVungoNativeResponse(&w, v)
...
func (v *Link) UnmarshalJSON(data []byte) error {
	...
	easyjson16eb09bcDecodeGithubComVungleVungoNativeResponse(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Link) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson16eb09bcDecodeGithubComVungleVungoNativeResponse(l, v)
}
