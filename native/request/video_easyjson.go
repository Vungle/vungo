...
func easyjson3c9ce8c3DecodeGithubComVungleVungoNativeRequest(in *jlexer.Lexer, out *Video) {
...
func easyjson3c9ce8c3EncodeGithubComVungleVungoNativeRequest(out *jwriter.Writer, in Video) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Video) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c9ce8c3EncodeGithubComVungleVungoNativeRequest(&w, v)
...
func (v *Video) UnmarshalJSON(data []byte) error {
	...
	easyjson3c9ce8c3DecodeGithubComVungleVungoNativeRequest(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Video) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c9ce8c3DecodeGithubComVungleVungoNativeRequest(l, v)
}
