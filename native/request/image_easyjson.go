...
func easyjson220accf5DecodeGithubComVungleVungoNativeRequest(in *jlexer.Lexer, out *Image) {
...
func easyjson220accf5EncodeGithubComVungleVungoNativeRequest(out *jwriter.Writer, in Image) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Type != 0 {
...
func (v Image) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson220accf5EncodeGithubComVungleVungoNativeRequest(&w, v)
...
func (v *Image) UnmarshalJSON(data []byte) error {
	...
	easyjson220accf5DecodeGithubComVungleVungoNativeRequest(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Image) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson220accf5DecodeGithubComVungleVungoNativeRequest(l, v)
}
