...
// PlacementType indicates the placement type.
...
const (
	...
	PlacementTypeAtomicContentUnit = 2
	// PlacementTypeOutsideCoreContent is the outside the core content - for example in the ads section on the right rail, as a banner-style placement near the content, etc.
	PlacementTypeOutsideCoreContent = 3
	// PlacementTypeRecommendationWidget is the recommendation widget, most commonly presented below the article content.
	PlacementTypeRecommendationWidget = 4
